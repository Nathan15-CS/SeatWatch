# SeatWatch research — FULL ARCHIVE (chronological history)

This is the complete, append-only history of every batch, sweep, and dead-end. The lean working
summary is in research/README.md. Nothing here is deleted — grep this file for any past detail.
Split out of README.md on July 10 2026 to keep the working file cheap to read.
