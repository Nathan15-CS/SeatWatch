...
class LCTCS(Banner):
    # SHARED HOST, AND IT FLAPS. Probed repeatedly 2026-08-01: the same query returns the
    # right sections most of the time and ZERO the rest — ftcc-la gave 9,9,9,0,9,9
    ...
    # Classes stay so the research survives. Before relisting ANY of them, prove stability
    # across REPEATED probes — a single clean probe is what let ftcc-la ship this morning,
    # and it was live and flapping for hours.
...
_ALL_SCHOOLS = ([UMD(), Rutgers(), Cornell(), Penn(), VirginiaTech(), OhioState(),
                             ...
                             # slcc-la / bpcc / rpcc / nunez DELISTED 2026-08-01 — LCTCS
                             # host flaps; see the note on the LCTCS base class.
...
SCHOOLS = _guard_registry(_ALL_SCHOOLS + [UDelaware(), Niagara(), UCI(), UCSC(), UCSB(), UCLA(), SFSU(), SacState(), CSUN(), IowaState(), TAMU(), Purdue(), UtahU(),
    ...
    FrontierCC()])   # ftcc-la DELISTED 2026-08-01 — LCTCS host flaps
