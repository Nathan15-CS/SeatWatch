...
<title>SeatWatch — Get a text the second a full class opens | 710 universities</title>
<meta name="description" content="SeatWatch alerts you the instant a seat opens in a full college class, across 710 universities. Watch the exact section you want and get the professor you want. Free to start.">
...
<meta property="og:description" content="Get an instant alert the second a seat opens in a full college class — across 710 universities. Watch the exact section, get the professor you want.">
...
<meta name="twitter:description" content="Get an instant alert the second a seat opens in a full college class. 710 universities. Free to start.">
 ...
 *{box-sizing:border-box}
 ...
 body::before{content:"";position:fixed;inset:0;z-index:-2;background-image:linear-gradient(var(--line) 1px,transparent 1px),linear-gradient(90deg,var(--line) 1px,transparent 1px);background-size:48px 48px;opacity:.5;-webkit-mask-image:radial-gradient(710px 520px at 50% -40px,#000,transparent 72%);mask-image:radial-gradient(710px 520px at 50% -40px,#000,transparent 72%)}
...
<section class="blk sr">
 ...
 <div class="faq">
  ...
  <details><summary>Is my school supported?<span class="pm">+</span></summary><p>We watch classes at <b data-count2="710">710</b> universities and colleges, and we're adding more every week. Start typing your school in the box above — if it's there, you're good to go.</p></details>
