...
<title>SeatWatch — Get a text the second a full class opens | 724 universities</title>
<meta name="description" content="SeatWatch alerts you the instant a seat opens in a full college class, across 724 universities. Watch the exact section you want and get the professor you want. Free to start.">
...
<meta property="og:description" content="Get an instant alert the second a seat opens in a full college class — across 724 universities. Watch the exact section, get the professor you want.">
 ...
 *{box-sizing:border-box}
 ...
 body::before{content:"";position:fixed;inset:0;z-index:-2;background-image:linear-gradient(var(--line) 1px,transparent 1px),linear-gradient(90deg,var(--line) 1px,transparent 1px);background-size:48px 48px;opacity:.5;-webkit-mask-image:radial-gradient(724px 520px at 50% -40px,#000,transparent 72%);mask-image:radial-gradient(724px 520px at 50% -40px,#000,transparent 72%)}
 body::after{content:"";position:fixed;inset:0;z-index:-1;background:radial-gradient(724px 440px at 50% -130px,rgba(37,99,235,.12),transparent 68%),radial-gradient(600px 400px at 88% 8%,rgba(16,185,129,.05),transparent 60%)}
...
FORM = """<section class="hero">
 <div class="badge reveal"><span class="dotlive"></span>LIVE — WATCHING 724 UNIVERSITIES</div>
 ...
 <div class="stats reveal d4">
  <div class="stat"><div class="chip"><svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"/></svg></div><b data-count="724">724</b><span>universities</span></div>
...
<section class="blk sr">
 ...
 <div class="faq">
  ...
  <details><summary>Is my school supported?<span class="pm">+</span></summary><p>We watch classes at <b data-count2="724">724</b> universities and colleges, and we're adding more every week. Start typing your school in the box above — if it's there, you're good to go.</p></details>
