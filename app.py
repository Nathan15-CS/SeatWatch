...
<title>SeatWatch — Get a text the second a full class opens | 730 universities</title>
<meta name="description" content="SeatWatch alerts you the instant a seat opens in a full college class, across 730 universities. Watch the exact section you want and get the professor you want. Free to start.">
...
<meta property="og:description" content="Get an instant alert the second a seat opens in a full college class — across 730 universities. Watch the exact section, get the professor you want.">
 ...
 *{box-sizing:border-box}
 ...
 body::before{content:"";position:fixed;inset:0;z-index:-2;background-image:linear-gradient(var(--line) 1px,transparent 1px),linear-gradient(90deg,var(--line) 1px,transparent 1px);background-size:48px 48px;opacity:.5;-webkit-mask-image:radial-gradient(730px 520px at 50% -40px,#000,transparent 72%);mask-image:radial-gradient(730px 520px at 50% -40px,#000,transparent 72%)}
 body::after{content:"";position:fixed;inset:0;z-index:-1;background:radial-gradient(730px 440px at 50% -130px,rgba(37,99,235,.12),transparent 68%),radial-gradient(600px 400px at 88% 8%,rgba(16,185,129,.05),transparent 60%)}
...
FORM = """<section class="hero">
 <div class="badge reveal"><span class="dotlive"></span>LIVE — WATCHING 730 UNIVERSITIES</div>
 ...
 <div class="stats reveal d4">
  <div class="stat"><div class="chip"><svg width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.42 10.922a1 1 0 0 0-.019-1.838L12.83 5.18a2 2 0 0 0-1.66 0L2.6 9.08a1 1 0 0 0 0 1.832l8.57 3.908a2 2 0 0 0 1.66 0z"/><path d="M22 10v6"/><path d="M6 12.5V16a6 3 0 0 0 12 0v-3.5"/></svg></div><b data-count="730">730</b><span>universities</span></div>
...
<section class="blk sr">
 ...
 <div class="faq">
  ...
  <details><summary>Is my school supported?<span class="pm">+</span></summary><p>We watch classes at <b data-count2="730">730</b> universities and colleges, and we're adding more every week. Start typing your school in the box above — if it's there, you're good to go.</p></details>
...
<p><b>4. You register yourself.</b> SeatWatch only sends alerts &mdash; it does not enroll you in anything. Actually registering for a class is your responsibility, and we are not responsible for whether you get a seat, a professor, a time, or a class.</p>
...
<p><b>6. Payments.</b> Your first class is free. Paid plans are one-time payments for a single academic term &mdash; they are not subscriptions and do not auto-renew &mdash; at the prices shown when you buy. Payments are processed by our payment provider (Stripe); we never see or store your full card details. Except where the law requires otherwise, all payments are final and non-refundable. You are responsible for any applicable taxes. Prices and plans may change for future terms.</p>
...
<p><b>8. Disclaimer of warranties.</b> The service is provided &ldquo;as is&rdquo; and &ldquo;as available,&rdquo; without warranties of any kind, express or implied &mdash; including any implied warranties of merchantability, fitness for a particular purpose, accuracy, or non-infringement, and any warranty that the service will be uninterrupted, timely, secure, or error-free.</p>
<p><b>9. Limitation of liability.</b> To the fullest extent permitted by law, SeatWatch LLC and its owners, creators, and operators will not be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages, or for any missed or lost class, lost opportunity, lost data, or other loss, arising from or relating to your use of (or inability to use) the service &mdash; even if advised such damages were possible. Our total liability for any claim will not exceed the greater of (a) the amount you paid us in the 12 months before the claim, or (b) US $100.</p>
...
<p><b>16. Contact.</b> Questions? Reach the SeatWatch LLC team at <a href="mailto:support@seatwatchapp.com">support@seatwatchapp.com</a>.</p>
</div>
...
<p><b>12. Contact / data removal.</b> Want your data removed, or have a question? Contact the SeatWatch LLC team at <a href="mailto:support@seatwatchapp.com">support@seatwatchapp.com</a>.</p>
</div>
